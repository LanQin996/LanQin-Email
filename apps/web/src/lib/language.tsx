...
const exactTranslations: Record<string, Translation> = {
  ...
  "请至少选择一个文件夹、标签或星标邮件": { "zh-TW": "請至少選擇一個資料夾、標籤或星號郵件", en: "Select at least one folder, label, or starred mail" },
  ...
  "当前筛选没有匹配的发送任务": { "zh-TW": "目前篩選沒有符合的傳送任務", en: "No send tasks match the current filters" },
...
const templateTranslations: { pattern: RegExp; "zh-TW": string; en: string }[] = [
  { pattern: /^保持当前（(.+) 到期）$/, "zh-TW": "保持目前（$1 到期）", en: "Keep current (expires $1)" },
