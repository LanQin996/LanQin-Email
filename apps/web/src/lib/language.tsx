...
const exactTranslations: Record<string, Translation> = {
  ...
  每页邮件数: { "zh-TW": "每頁郵件數", en: "Messages per page" },
  上一页: { "zh-TW": "上一頁", en: "Previous page" },
  下一页: { "zh-TW": "下一頁", en: "Next page" },
  ...
  "检测中...": { "zh-TW": "檢測中...", en: "Checking..." },
  "同步中...": { "zh-TW": "同步中...", en: "Syncing..." },
  邮箱共享: { "zh-TW": "信箱共享", en: "Mailbox sharing" },
  创建只读共享: { "zh-TW": "建立唯讀共享", en: "Create read-only share" },
  只读访问: { "zh-TW": "唯讀存取", en: "Read-only access" },
  共享邮箱: { "zh-TW": "共享信箱", en: "Mailbox" },
  站内用户: { "zh-TW": "站內使用者", en: "User" },
  搜索用户名或邮箱: { "zh-TW": "搜尋使用者名稱或信箱", en: "Search name or email" },
  "搜索中...": { "zh-TW": "搜尋中...", en: "Searching..." },
  未找到可共享用户: { "zh-TW": "找不到可共享的使用者", en: "No eligible users found" },
  有效期: { "zh-TW": "有效期限", en: "Expires" },
  永不过期: { "zh-TW": "永不過期", en: "Never expires" },
  共享范围: { "zh-TW": "共享範圍", en: "Share scope" },
  全部内容: { "zh-TW": "全部內容", en: "All content" },
  自定义范围: { "zh-TW": "自訂範圍", en: "Custom scope" },
  文件夹: { "zh-TW": "資料夾", en: "Folders" },
  暂无自定义标签: { "zh-TW": "暫無自訂標籤", en: "No custom labels" },
  "请至少选择一个文件夹、标签或星标邮件": {
    "zh-TW": "請至少選擇一個資料夾、標籤或星號郵件",
    en: "Select at least one folder, label, or starred mail",
  },
  创建共享: { "zh-TW": "建立共享", en: "Create share" },
  "共享中...": { "zh-TW": "共享中...", en: "Sharing..." },
  共享记录: { "zh-TW": "共享記錄", en: "Shares" },
  暂无共享记录: { "zh-TW": "暫無共享記錄", en: "No shares" },
  我的邮箱: { "zh-TW": "我的信箱", en: "My mailboxes" },
  共享给我: { "zh-TW": "與我共享", en: "Shared with me" },
  共享: { "zh-TW": "共享", en: "Shared" },
  只读: { "zh-TW": "唯讀", en: "Read only" },
  撤销共享: { "zh-TW": "撤銷共享", en: "Revoke share" },
  "撤销邮箱共享？": { "zh-TW": "撤銷信箱共享？", en: "Revoke mailbox share?" },
  编辑共享: { "zh-TW": "編輯共享", en: "Edit share" },
  编辑邮箱共享: { "zh-TW": "編輯信箱共享", en: "Edit mailbox share" },
  共享给: { "zh-TW": "共享給", en: "Shared with" },
  共享设置已更新: { "zh-TW": "共享設定已更新", en: "Share settings updated" },
  更新失败: { "zh-TW": "更新失敗", en: "Update failed" },
  "保存中...": { "zh-TW": "儲存中...", en: "Saving..." },
  保存更改: { "zh-TW": "儲存變更", en: "Save changes" },
  "重新设置为 7 天": { "zh-TW": "重新設定為 7 天", en: "Reset to 7 days" },
  "重新设置为 30 天": { "zh-TW": "重新設定為 30 天", en: "Reset to 30 days" },
  "重新设置为 90 天": { "zh-TW": "重新設定為 90 天", en: "Reset to 90 days" },
  ...
  "例如：客户、账单、项目归档": {
    "zh-TW": "例如：客戶、帳單、專案封存",
    en: "e.g. Clients, invoices, project archive",
  },
  ...
  当前筛选条件下没有远端邮件: {
    "zh-TW": "目前篩選條件下沒有遠端郵件",
    en: "No remote messages match the current filters",
  },
  没有待发送邮件: { "zh-TW": "沒有待傳送郵件", en: "No scheduled mail" },
  当前搜索没有匹配的定时邮件: {
    "zh-TW": "目前搜尋沒有符合的定時郵件",
    en: "No scheduled messages match your search",
  },
  发送队列为空: { "zh-TW": "傳送佇列為空", en: "Send queue is empty" },
  当前搜索没有匹配的发送任务: {
    "zh-TW": "目前搜尋沒有符合的傳送任務",
    en: "No send tasks match your search",
  },
  当前筛选没有匹配的发送任务: {
    "zh-TW": "目前篩選沒有符合的傳送任務",
    en: "No send tasks match the current filters",
  },
  当前筛选条件下没有邮件: {
    "zh-TW": "目前篩選條件下沒有郵件",
    en: "No messages match the current filters",
  },
  ...
  筛选: { "zh-TW": "篩選", en: "Filters" },
  "搜索 Message-ID": { "zh-TW": "搜尋 Message-ID", en: "Search Message-ID" },
  搜索收件人: { "zh-TW": "搜尋收件者", en: "Search recipient" },
  开始时间: { "zh-TW": "開始時間", en: "Start time" },
  结束时间: { "zh-TW": "結束時間", en: "End time" },
  至: { "zh-TW": "至", en: "to" },
  重置筛选: { "zh-TW": "重設篩選", en: "Reset filters" },
  状态: { "zh-TW": "狀態", en: "Status" },
  邮件: { "zh-TW": "郵件", en: "Message" },
  投递信息: { "zh-TW": "投遞資訊", en: "Delivery" },
  更新时间: { "zh-TW": "更新時間", en: "Updated" },
  操作: { "zh-TW": "操作", en: "Actions" },
  查看时间线: { "zh-TW": "檢視時間軸", en: "View timeline" },
  重试任务: { "zh-TW": "重試任務", en: "Retry task" },
  取消任务: { "zh-TW": "取消任務", en: "Cancel task" },
  ...
  "请在个人中心申请邮箱，或联系管理员为当前账号分配邮箱。": {
    "zh-TW": "請在個人中心申請信箱，或聯絡管理員為目前帳號分配信箱。",
    en: "Apply for a mailbox in Profile, or contact an administrator to assign one to this account.",
  },
  前往个人中心: { "zh-TW": "前往個人中心", en: "Go to profile" },
  无邮箱前台权限: { "zh-TW": "無信箱前台權限", en: "No mailbox access" },
  "当前账号未开启邮箱前台访问权限。": {
    "zh-TW": "目前帳號未開啟信箱前台存取權限。",
    en: "Mailbox access is not enabled for this account.",
  },
  无邮件查看权限: { "zh-TW": "無郵件檢視權限", en: "No mail read permission" },
  "当前账号可以访问邮箱前台，但未开启邮件查看权限。": {
    "zh-TW": "目前帳號可以存取信箱前台，但未開啟郵件檢視權限。",
    en: "This account can access mailbox UI, but mail reading is not enabled.",
  },
  无定时发送权限: { "zh-TW": "無定時傳送權限", en: "No scheduled send permission" },
  "当前账号不能查看或管理定时发送任务。": {
    "zh-TW": "目前帳號不能檢視或管理定時傳送任務。",
    en: "This account cannot view or manage scheduled send tasks.",
  },
  无发送队列权限: { "zh-TW": "無傳送佇列權限", en: "No send queue permission" },
  "当前账号不能查看发送队列。": {
    "zh-TW": "目前帳號不能檢視傳送佇列。",
    en: "This account cannot view the send queue.",
  },
  ...
  这封草稿已在待发送队列中: {
    "zh-TW": "這封草稿已在待傳送佇列中",
    en: "This draft is already scheduled",
  },
  "请先取消定时发送，再继续编辑。": {
    "zh-TW": "請先取消定時傳送，再繼續編輯。",
    en: "Cancel the scheduled send before editing.",
  },
  打开草稿失败: { "zh-TW": "開啟草稿失敗", en: "Failed to open draft" },
  "文件夹内的邮件会移回收件箱，不会被删除。": {
    "zh-TW": "資料夾內的郵件會移回收件匣，不會被刪除。",
    en: "Messages in this folder will be moved back to Inbox, not deleted.",
  },
  ...
  发送时间需要晚于当前时间: {
    "zh-TW": "傳送時間需要晚於目前時間",
    en: "Send time must be in the future",
  },
...
const templateTranslations: { pattern: RegExp; "zh-TW": string; en: string }[] = [
  {
    pattern: /^保持当前（(.+) 到期）$/,
    "zh-TW": "保持目前（$1 到期）",
    en: "Keep current (expires $1)",
  },
  { pattern: /^来自 (.+)$/, "zh-TW": "來自 $1", en: "From $1" },
  { pattern: /^(\d+) 项$/, "zh-TW": "$1 項", en: "$1 items" },
  { pattern: /^第 (\d+) 页$/, "zh-TW": "第 $1 頁", en: "Page $1" },
  { pattern: /^(\d+)–(\d+) \/ (\d+)$/, "zh-TW": "$1–$2 / $3", en: "$1–$2 of $3" },
  { pattern: /^(.+) 到期$/, "zh-TW": "$1 到期", en: "Expires $1" },
  ...
  {
    pattern: /^已标记 (\d+) 封邮件为已读$/,
    "zh-TW": "已標記 $1 封郵件為已讀",
    en: "Marked $1 messages as read",
  },
  { pattern: /^已处理 (\d+) 封邮件$/, "zh-TW": "已處理 $1 封郵件", en: "Processed $1 messages" },
  {
    pattern: /^将删除当前选中的 (\d+) 封邮件，此操作无法从邮件列表中恢复。$/,
    "zh-TW": "將刪除目前選取的 $1 封郵件，此操作無法從郵件清單中復原。",
    en: "This will delete the $1 selected messages. This cannot be undone from the message list.",
  },
  {
    pattern: /^邮件“(.+)”将被删除。$/,
    "zh-TW": "郵件「$1」將被刪除。",
    en: "Message “$1” will be deleted.",
  },
  ...
  {
    pattern: /^已将 (\d+) 封邮件移回收件箱$/,
    "zh-TW": "已將 $1 封郵件移回收件匣",
    en: "Moved $1 messages back to Inbox",
  },
  ...
  { pattern: /^发送时间：(.+)$/, "zh-TW": "傳送時間：$1", en: "Send time: $1" },
  {
    pattern: /^当前单个附件上限 (.+)$/,
    "zh-TW": "目前單個附件上限 $1",
    en: "Current per-attachment limit: $1",
  },
